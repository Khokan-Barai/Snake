...
public class Snake {
    ...
    // Constants
    private final int SNAKE_RUNNING_SPEED_FASTEST = 50;
    private final int SNAKE_RUNNING_SPEED_FASTER = 80;
    private final int SNAKE_RUNNING_SPEED_FAST = 140;
    private final int BOARD_WIDTH = 500;
    private final int BOARD_HEIGHT = 300;
    private final int SCORE_BOARD_HEIGHT = 50;
    ...
    public void init() {
        ...
        scoreViewer = new JTextArea("                                        Your Score ==>     " + score);
        scoreViewer.setEnabled(false);
        scoreViewer.setBackground(Color.BLACK);
        
        //board.setBorder((Border) Color.CYAN); 
        board = new JPanel();
    ...
    public void setJMenueBar(JFrame frame) {
        ...
        JMenuItem noMaze = new JMenuItem("No Border");
        ...
        JMenuItem border = new JMenuItem("With Border");
        ...
        creator.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {                
                JOptionPane.showMessageDialog(null, "KHOKAN BARAI \nCSE, D-41 (DIU)\nPresented by sir \nMr.Mahmudul Hasan\n&\nThanks to all...");
            }
        });
        instruction.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {                
                JOptionPane.showMessageDialog(null, "This game play by Right,Left,Top & Down Button in your Keyboard.\nClick to 'Type' Button for Play the Game on Different way.\nClick to 'Level' Button for Play the Game on Different Speed.\nClick to 'Game' Button for Exit the Game or Again Play.");
            }
        });
  ...
  void startNewGame() {
    ...
    void processNextStep() {
        ...
        if(isGameOver(isBorderTouched, newHeadLocX, newHeadLocY)) {
           scoreViewer.setText("                                        GAME is  OVER !!!  Score is :    " + score+"\n                                  If you want to play this Game Again...\n                     Please go to the 'Game' Button And Click the 'New  Game' Button. ");
           scoreViewer.setBackground(Color.RED);  
    ...
    public void snakeKeyPressed(KeyEvent e) {
        ...
        if (isRunningLeft == true && e.getKeyCode() == 37) {
            ...
            directionY = 0;
            isRunningRight = false;     // means snake can't move from left to right
